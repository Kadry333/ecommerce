        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="<?php echo url("home");?>">Home</a></li>
                        <li><a class="text-decoration-none" href="<?php echo url("about");?>">About Us</a></li>
                        <li><a class="text-decoration-none" href="<?php echo url("shop");?>">Shop</a></li>
                        <li><a class="text-decoration-none" href="<?php echo url("contact");?>">Contact</a></li>

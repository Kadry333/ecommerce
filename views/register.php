...
<?php require_once Root_Path."inc/nav.php";?>
    ...
    <span class="text-success" style="font-size: 40px; font-weight: bold; display: block; text-align: center; line-height: 1.5; padding: 10px;">
        ...
        <form class="col-md-9 m-auto border p-5" method="post" action="<?php echo url('check-register'); ?>" role="form">
            <div class="row">
                ...
                <div class="form-group col-md-12 mb-3 text-center">
                    ...
                    <a href="<?php echo url('login'); ?>" class="btn btn-link text-decoration-none" style="font-weight: bold; color: #007bff;">
                                Login
        </a>
    </p>
               </div>
